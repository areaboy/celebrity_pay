...
$public_url = $json['invoice']['public_url'];
...
echo "You Can also Make Payments by Clicking the Payments Link below:<br><br>
<a target='_blank' href='$public_url'>Complete Invoice Payments Now</a>";
